...
int32_t yang_sdp_genLocalSdp(YangRtcSession* session,int32_t localport, char**sdp,YangStreamDirection role);
int32_t yang_sdp_genLocalSdp2(YangRtcSession *session, int32_t localport,char *sdp, YangStreamDirection role);
