...
#endif
#ifdef ENABLE_WEBRTC
#include "../zlm_webrtc/WebRtcPlayer.h"
#include "../zlm_webrtc/WebRtcPusher.h"
#include "../zlm_webrtc/WebRtcEchoTest.h"
#endif
#ifdef _WIN32
#include <io.h>
#include <iostream>
    ...
    api_regist("/index/api/restartServer", [](API_ARGS_MAP) {
        ...
        if (err == 0) {
            ...
            EventPollerPool::Instance().getPoller()->doDelayTask(1000, []() {
                ...
                BOOL bRet = CreateProcess(appName, (LPSTR)" /c RestartServer.cmd", NULL, NULL, FALSE, 0, NULL, NULL, &si, &pi);
