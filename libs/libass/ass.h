...
Rect ass_cursor_pos(ASS_Renderer* priv, ASS_Track* track, long long now, int index);

Rect ass_bound_rect(ASS_Renderer* priv, ASS_Track* track, long long now, const char* name);
