...
static const vp9_coeff_probs_model default_coef_probs_4x4[VP9_PLANE_TYPES] = {
  {     // Y plane
    {   // Intra
      { // Band 0
        { 195, 29, 183 },
...
static const vp9_coeff_probs_model default_coef_probs_8x8[VP9_PLANE_TYPES] = {
  {     // Y plane
    {   // Intra
      { // Band 0
        { 125, 34, 187 },
...
static const vp9_coeff_probs_model default_coef_probs_16x16[VP9_PLANE_TYPES] = {
  {     // Y plane
    {   // Intra
      { // Band 0
        { 7, 27, 153 },
...
static const vp9_coeff_probs_model default_coef_probs_32x32[VP9_PLANE_TYPES] = {
  {     // Y plane
    {   // Intra
      { // Band 0
        { 17, 38, 140 },
