...
#define INTER_OFFSET(mode) ((mode)-VP9_NEARESTMV)
...
typedef struct frame_contexts {
  ...
  vp9_coeff_probs_model coef_probs[TX_SIZES][VP9_PLANE_TYPES];
...
typedef struct FRAME_COUNTS {
  ...
  vp9_coeff_count_model coef[TX_SIZES][VP9_PLANE_TYPES];
  unsigned int eob_branch[TX_SIZES][VP9_PLANE_TYPES][REF_TYPES][COEF_BANDS]
                         [COEFF_CONTEXTS];
