...
#define INIT_ALL_SIZES(p, type)               \
  ...
  INIT_ALL_SIZES(pred[VP9_V_PRED], v);
  INIT_ALL_SIZES(pred[VP9_H_PRED], h);
  INIT_ALL_SIZES(pred[VP9_D207_PRED], d207);
  INIT_ALL_SIZES(pred[VP9_D45_PRED], d45);
  INIT_ALL_SIZES(pred[VP9_D63_PRED], d63);
  INIT_ALL_SIZES(pred[VP9_D117_PRED], d117);
  INIT_ALL_SIZES(pred[VP9_D135_PRED], d135);
  INIT_ALL_SIZES(pred[VP9_D153_PRED], d153);
  INIT_ALL_SIZES(pred[VP9_TM_PRED], tm);
...
#if CONFIG_VP9_HIGHBITDEPTH
  INIT_ALL_SIZES(pred_high[VP9_V_PRED], highbd_v);
  INIT_ALL_SIZES(pred_high[VP9_H_PRED], highbd_h);
  INIT_ALL_SIZES(pred_high[VP9_D207_PRED], highbd_d207);
  INIT_ALL_SIZES(pred_high[VP9_D45_PRED], highbd_d45);
  INIT_ALL_SIZES(pred_high[VP9_D63_PRED], highbd_d63);
  INIT_ALL_SIZES(pred_high[VP9_D117_PRED], highbd_d117);
  INIT_ALL_SIZES(pred_high[VP9_D135_PRED], highbd_d135);
  INIT_ALL_SIZES(pred_high[VP9_D153_PRED], highbd_d153);
  INIT_ALL_SIZES(pred_high[VP9_TM_PRED], highbd_tm);
