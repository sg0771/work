...
enum {
  INTRA_ALL = (1 << VP9_DC_PRED) | (1 << VP9_V_PRED) | (1 << VP9_H_PRED) |
              (1 << VP9_D45_PRED) | (1 << VP9_D135_PRED) |
              (1 << VP9_D117_PRED) | (1 << VP9_D153_PRED) |
              (1 << VP9_D207_PRED) | (1 << VP9_D63_PRED) | (1 << VP9_TM_PRED),
  INTRA_DC = (1 << VP9_DC_PRED),
  INTRA_DC_TM = (1 << VP9_DC_PRED) | (1 << VP9_TM_PRED),
  INTRA_DC_H_V = (1 << VP9_DC_PRED) | (1 << VP9_V_PRED) | (1 << VP9_H_PRED),
  INTRA_DC_TM_H_V = (1 << VP9_DC_PRED) | (1 << VP9_TM_PRED) |
                    (1 << VP9_V_PRED) | (1 << VP9_H_PRED)
};

enum {
  INTER_ALL = (1 << VP9_NEARESTMV) | (1 << VP9_NEARMV) | (1 << VP9_ZEROMV) |
              (1 << VP9_NEWMV),
  INTER_NEAREST = (1 << VP9_NEARESTMV),
  INTER_NEAREST_NEW = (1 << VP9_NEARESTMV) | (1 << VP9_NEWMV),
  INTER_NEAREST_ZERO = (1 << VP9_NEARESTMV) | (1 << VP9_ZEROMV),
  INTER_NEAREST_NEW_ZERO =
      (1 << VP9_NEARESTMV) | (1 << VP9_ZEROMV) | (1 << VP9_NEWMV),
  INTER_NEAREST_NEAR_NEW =
      (1 << VP9_NEARESTMV) | (1 << VP9_NEARMV) | (1 << VP9_NEWMV),
  INTER_NEAREST_NEAR_ZERO =
      (1 << VP9_NEARESTMV) | (1 << VP9_NEARMV) | (1 << VP9_ZEROMV),
};
