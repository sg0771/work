...
struct httpd_callbacks_s {
	void* opaque;
	void* (*conn_init)(int fd, void *opaque, unsigned char *local, int locallen, unsigned char *remote, int remotelen);
	void  (*conn_request)(void *ptr, http_request_t *request, http_response_t **response);
	void  (*conn_destroy)(void *ptr);
    void  (*conn_datafeed)(void *ptr, unsigned char *data, int size, unsigned long long uniqueid);
    void(*conn_mirror_destroy)();
    void(*set_mirror_stream)(unsigned long long uniqueid, int disconnect);
    int(*get_mirror_stream)(unsigned long long uniqueid);
};
