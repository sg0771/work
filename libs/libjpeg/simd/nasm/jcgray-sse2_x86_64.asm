...
; For conditions of distribution and use, see copyright notice in simd/nasm/jsimdext.inc
;
...
%include "simd/nasm/jsimdext.inc"
...
%include "simd/nasm/jcgryext-sse2_x86_64.inc"
