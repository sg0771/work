...
class Limiter : public GenericVideoFilter, public  SoftWire::CodeGenerator
{
public:
  ...
  SoftWire::DynamicAssembledCode create_emulator(int row_size, int height, IScriptEnvironment* env);
  ~Limiter();
private:
  bool luma_emulator;
  ...
  SoftWire::DynamicAssembledCode assemblerY;
  SoftWire::DynamicAssembledCode assemblerUV;
