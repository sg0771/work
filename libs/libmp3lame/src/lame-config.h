/* lame-config.h.  Generated from lame-config.h.in by configure.  */
/* lame-config.h.in.  Generated from configure.in by autoheader.  */
...
#define PACKAGE_STRING "lame 3.99"
