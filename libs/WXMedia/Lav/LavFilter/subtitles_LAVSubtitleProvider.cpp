...
#include "WXVideo_LAVSubtitleProvider.h"
  ...
  , m_pLAVVideo(pLAVVideo)
{
  ...
  context.name = (LPWSTR)TEXT(LAV_VIDEO);
  context.version = (LPWSTR)L"0.71.0";// TEXT(LAV_VERSION_STR);
  context.yuvMatrix = (LPWSTR)_T("PC.601");
