...
public:
  ...
  AM_SimpleRateChange GetDVDRateChange() { DSAutoLock DSAutoLock(&m_csRateLock); return m_ratechange; }
...
private:
  ...
  int m_CorrectTS = 0;
  AM_SimpleRateChange m_ratechange = AM_SimpleRateChange{(REFERENCE_TIME)AV_NOPTS_VALUE, 10000};
