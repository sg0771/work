...
private:
  ...
  struct {
    HMODULE mfplat = NULL;
    tMFStartup* Startup;
    tMFShutdown* Shutdown;
    tMFCreateAlignedMemoryBuffer* CreateAlignedMemoryBuffer;
    tMFCreateSample* CreateSample;
    tMFCreateMediaType* CreateMediaType;
    tMFAverageTimePerFrameToFrameRate* AverageTimePerFrameToFrameRate;
  } MF;
};
