...
STDMETHODIMP CDecAvcodec::InitDecoder(AVCodecID codec, const CMediaType *pmt)
{
  ...
  m_pAVCtx->thread_count = std::max(1, std::min(thread_count, AVCODEC_MAX_THREADS));
