...
#include "Demuxers_StreamInfo.h"
#include "Demuxers_Packet.h"
...
public:
    ...
    class stream {
	public:
        CStreamInfo* streamInfo = nullptr;
        DWORD pid = 0;
        std::string language;
        ...
        bool operator == (const stream& s) const { return (DWORD)*this == (DWORD)s; }
    } ;
...
#define LAVFMT_TS_DISCONT_NO_DOWNSTREAM 0x0002
    ...
    std::string m_strError = "";//open_input 打开失败
    const char* GetError() {
