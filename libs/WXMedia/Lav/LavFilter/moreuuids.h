...
// CFHD
DEFINE_GUID(MEDIASUBTYPE_CFHD,
	MAKEFOURCC('C', 'F', 'H', 'D'), 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xAA, 0x00, 0x38, 0x9B, 0x71);

// MagicYUV
DEFINE_GUID(MEDIASUBTYPE_MAGY,
	MAKEFOURCC('M', 'A', 'G', 'Y'), 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xAA, 0x00, 0x38, 0x9B, 0x71);
...
DEFINE_GUID(MEDIASUBTYPE_ROQV,
	MAKEFOURCC('R', 'o', 'Q', 'V'), 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xAA, 0x00, 0x38, 0x9B, 0x71);
...
DEFINE_GUID(IID_IMFTransform,
	0xbf94c121, 0x5b05, 0x4e6f, 0x80, 0x00, 0xba, 0x59, 0x89, 0x61, 0x41, 0x40);


//uncompressed
#define FOURCC_YUY2LAV mmioFOURCC('Y','U','Y','2')
#define FOURCC_V422 mmioFOURCC('V','4','2','2')
#define FOURCC_YV12LAV mmioFOURCC('Y','V','1','2')
#define FOURCC_YVYU mmioFOURCC('Y','V','Y','U')
#define FOURCC_UYVYLAV mmioFOURCC('U','Y','V','Y')
#define FOURCC_YUYVLAV mmioFOURCC('Y','U','Y','V')
#define FOURCC_VYUY mmioFOURCC('V','Y','U','Y')
#define FOURCC_I420LAV mmioFOURCC('I','4','2','0')
#define FOURCC_IYUVLAV mmioFOURCC('I','Y','U','V')
#define FOURCC_444P mmioFOURCC('4','4','4','P')
#define FOURCC_YV24LAV mmioFOURCC('Y','V','2','4') // YUV 4:4:4
#define FOURCC_422P mmioFOURCC('4','2','2','P')
#define FOURCC_YV16LAV mmioFOURCC('Y','V','1','6') // YUV 4:2:2
...
#define FOURCC_RGB3LAV mmioFOURCC('R','G','B','3')
...
#define FOURCC_NV12LAV mmioFOURCC('N','V','1','2')
#define FOURCC_NV21LAV mmioFOURCC('N','V','2','1')
...
DEFINE_GUID_FOURCC(NV21LAV)
DEFINE_GUID_FOURCC(YV16LAV)
DEFINE_GUID_FOURCC(YV24LAV)


DEFINE_GUID(CLSID_IVSFilter,
