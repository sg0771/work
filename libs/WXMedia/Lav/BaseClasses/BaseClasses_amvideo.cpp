...
const struct {
    ...
    CHAR *pName;
    WCHAR *wszName;
} BitCountMap[] =  { &MEDIASUBTYPE_RGB1,        1,  (CHAR*) "RGB Monochrome",     (WCHAR*)L"RGB Monochrome",
                     &MEDIASUBTYPE_RGB4,        4,   (CHAR*)"RGB VGA",            (WCHAR*)L"RGB VGA",
                     &MEDIASUBTYPE_RGB8,        8,   (CHAR*)"RGB 8",              (WCHAR*)L"RGB 8",
                     &MEDIASUBTYPE_RGB565,      16, (CHAR*)"RGB 565 (16 bit)",   (WCHAR*)L"RGB 565 (16 bit)",
                     &MEDIASUBTYPE_RGB555,      16,  (CHAR*)"RGB 555 (16 bit)",   (WCHAR*)L"RGB 555 (16 bit)",
                     &MEDIASUBTYPE_RGB24,       24,  (CHAR*)"RGB 24",             (WCHAR*)L"RGB 24",
                     &MEDIASUBTYPE_RGB32,       32, (CHAR*)"RGB 32",             (WCHAR*)L"RGB 32",
                     &MEDIASUBTYPE_ARGB32,    32,  (CHAR*)"ARGB 32",             (WCHAR*)L"ARGB 32",
                     &MEDIASUBTYPE_Overlay,     0,   (CHAR*)"Overlay",            (WCHAR*)L"Overlay",
                     &GUID_NULL,                0,   (CHAR*)"UNKNOWN",            (WCHAR*)L"UNKNOWN"
};
