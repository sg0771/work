                        ...
                        ff_const59 AVInputFormat *fmt, AVDictionary **options)
{
    ...
    if (fmt) {
        ...
        char* last4 = (char*)(filename + (length - 4));
        if (!av_strcasecmp(last4,"webm")) {
            av_log(NULL, AV_LOG_ERROR, "Is WEBM Format\n");
            s->iformat = av_find_input_format("webm");
        }
    }
