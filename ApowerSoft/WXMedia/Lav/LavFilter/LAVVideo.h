...
#include "WXVideo_LAVVideoSettings.h"
#include "WXVideo_LAVSubtitleConsumer.h"
#include "WXVideo_LAVVideoSubtitleInputPin.h"
...
private:
  ...
  AM_SimpleRateChange  m_DVDRate = AM_SimpleRateChange{(REFERENCE_TIME)AV_NOPTS_VALUE, 10000};
