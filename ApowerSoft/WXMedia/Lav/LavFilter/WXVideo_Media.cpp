...
AVCodecID FindVideoCodecId(const CMediaType *mt)
{
...
static video_codec_config_t m_codec_config[] = {
...
const video_codec_config_t *get_codec_config(LAVVideoCodec codec)
{
	video_codec_config_t *config = &m_codec_config[codec];
