...
ISubClock2 :
	public ISubClock {
		...
		STDMETHOD(GetAvgTimePerFrame)(REFERENCE_TIME* prt) PURE;
	};
	...
	public IDirectVobSub {
		...
		STDMETHOD(get_AspectRatioSettings) (THIS_ EPARCompensationType* ePARCompensationType) PURE;
		STDMETHOD(put_AspectRatioSettings) (THIS_ EPARCompensationType* ePARCompensationType) PURE;
	};
