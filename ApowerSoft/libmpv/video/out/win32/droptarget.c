                                         ...
                                         DWORD *pdwEffect)
{
   ...
   // IDataObject_AddRef(pDataObj);
    ...
    if (FAILED(pDataObj->lpVtbl->QueryGetData(pDataObj, &fmtetc_file)) &&
        FAILED(pDataObj->lpVtbl->QueryGetData(pDataObj, &fmtetc_url)))
    {
                                    ...
                                    DWORD *pdwEffect)
{
    ...
    STGMEDIUM medium;
    if (SUCCEEDED(pDataObj->lpVtbl->GetData(pDataObj, &fmtetc_file, &medium))) {
    ...
    } else if (SUCCEEDED(pDataObj->lpVtbl->GetData(pDataObj, &fmtetc_url, &medium))) {
