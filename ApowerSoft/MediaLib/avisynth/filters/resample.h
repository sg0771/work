...
{
public:
static PClip CreateResize( PClip clip, int target_width, int target_height,IScriptEnvironment* env );
static AVSValue __cdecl Create_PointResize(AVSValue args,   void*, IScriptEnvironment* env);
static AVSValue __cdecl Create_TinyResize(AVSValue args,     void*, IScriptEnvironment* env);
