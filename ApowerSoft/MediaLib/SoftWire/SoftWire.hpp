...
namespace SoftWire
{
	...
	struct OperandREF : virtual Operand
	{
		...
		const OperandREF operator+(const void* disp) const
		{
			...
			returnReg.displacement = displacement + (intptr_t)disp;

			return returnReg;
		}

		const OperandREF operator+(intptr_t disp) const
		{
			OperandREF returnReg;
	...
	struct OperandMEM : virtual Operand
	{
		...
		const OperandMEM operator+(intptr_t disp) const
		{
	...
	struct OperandMEM8 : OperandMEM
	{
		...
		const OperandMEM8 operator+(intptr_t disp) const
		{
	...
	struct OperandMEM16 : OperandMEM
	{
		...
		const OperandMEM16 operator+(intptr_t disp) const
		{
	...
	struct OperandMEM32 : OperandMEM
	{
		...
		const OperandMEM32 operator+(intptr_t disp) const
		{
	...
	struct OperandMEM64 : OperandMEM
	{
		...
		const OperandMEM64 operator+(intptr_t disp) const
		{
	...
	struct OperandMEM128 : OperandMEM
	{
		...
		const OperandMEM128 operator+(intptr_t disp) const
		{
	...
	struct OperandREGxX : OperandREF
	{
		...
		friend const OperandREGxX operator+(const OperandREGxX& ref, intptr_t disp);
		friend const OperandREGxX operator-(const OperandREGxX& ref, intptr_t disp);
		...
		friend const OperandREGxX operator+(intptr_t disp, const OperandREGxX& ref);
		friend const OperandREGxX operator-(intptr_t disp, const OperandREGxX& ref);
	};
	...
	struct OperandREG32 : OperandR_M32, OperandREF, OperandREG
	{
		...
		friend const OperandREG32 operator+(const OperandREG32 ref, intptr_t disp);
		friend const OperandREG32 operator-(const OperandREG32 ref, intptr_t disp);
		...
		friend const OperandREG32 operator+(intptr_t disp, const OperandREG32 ref);
		friend const OperandREG32 operator-(intptr_t disp, const OperandREG32 ref);
	...
	struct OperandREG64 : OperandR_M64, OperandREF, OperandREG
	{
		...
		friend const OperandREG64 operator+(const OperandREG64 ref, intptr_t disp);
		friend const OperandREG64 operator-(const OperandREG64 ref, intptr_t disp);
		...
		friend const OperandREG64 operator+(intptr_t disp, const OperandREG64 ref);
		friend const OperandREG64 operator-(intptr_t disp, const OperandREG64 ref);
...
namespace SoftWire
{
	...
	inline const OperandREGxX operator+(const OperandREGxX& ref, void* disp)
	{
		...
		returnReg.displacement = ref.displacement + (intptr_t)disp;

		return returnReg;
	}

	inline const OperandREGxX operator+(const OperandREGxX& ref, intptr_t disp)
	{
		OperandREGxX returnReg;
	...
	inline const OperandREGxX operator+(intptr_t disp, const OperandREGxX& ref)
	{
		return ref + disp;
	}
	...
	inline const OperandREG32 operator+(const OperandREG32 ref, intptr_t disp)
	{
		OperandREG32 returnReg;
	...
	inline const OperandREG32 operator+(intptr_t disp, const OperandREG32 ref)
	{
		return ref + disp;
	}
	...
	inline const OperandREG64 operator+(const OperandREG64 ref, intptr_t disp)
	{
		OperandREG64 returnReg;
	...
	inline const OperandREG64 operator+(intptr_t disp, const OperandREG64 ref)
	{
		return ref + disp;
	}
...
namespace SoftWire
{
	...
	private:
		...
		void setDisplacement(intptr_t displacement);
