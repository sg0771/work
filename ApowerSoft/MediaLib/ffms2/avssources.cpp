...
static int SimpleFmt(int ffpixfmt)
{
    if (ffpixfmt == FFMS_GetPixFmt("yuvj420p") || ffpixfmt == FFMS_GetPixFmt("yuv420p"))
        return CS_I420;
    //else if (ffpixfmt == FFMS_GetPixFmt("yuva420p"))
    //    return CS_YUVA420;
    else if (ffpixfmt == FFMS_GetPixFmt("yuvj422p") || ffpixfmt == FFMS_GetPixFmt("yuv422p"))
        return CS_YV16;
    /* else if (ffpixfmt == FFMS_GetPixFmt("yuva422p"))
    return CS_YUVA422;*/
    else if (ffpixfmt == FFMS_GetPixFmt("yuvj444p") || ffpixfmt == FFMS_GetPixFmt("yuv444p"))
        return CS_YV24;
    /* else if (ffpixfmt == FFMS_GetPixFmt("yuva444p"))
    return CS_YUVA444;*/
    else if (ffpixfmt == FFMS_GetPixFmt("yuv411p"))
        return CS_YV411;
    else if (ffpixfmt == FFMS_GetPixFmt("yuv410p"))
        return CS_YUV9;
    else if (ffpixfmt == FFMS_GetPixFmt("gray8"))
        return CS_Y8;
    else if (ffpixfmt == FFMS_GetPixFmt("yuyv422"))
        return CS_YUY2;
    else if (ffpixfmt == FFMS_GetPixFmt("rgb32"))
        return CS_BGR32;
    else if (ffpixfmt == FFMS_GetPixFmt("bgr24"))
        return CS_BGR24;
    else if (ffpixfmt == AV_PIX_FMT_YUV422P10BE || ffpixfmt == AV_PIX_FMT_YUV422P10LE
        || ffpixfmt == AV_PIX_FMT_YUV422P9BE || ffpixfmt == AV_PIX_FMT_YUV422P9LE)
        return CS_I420;

    //10bit HEVC/H264
    //Add By Tam.Xie
    //2024.08.08
    else if (ffpixfmt == AV_PIX_FMT_YUV420P10LE || ffpixfmt == AV_PIX_FMT_YUV420P10BE)
        return CS_I420;
    else if (ffpixfmt == AV_PIX_FMT_YUV420P9LE || ffpixfmt == AV_PIX_FMT_YUV420P9BE)
        return CS_I420;
