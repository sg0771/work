...
public:
     ...
     */
    static Uri parse(cxx17::string_view str);
    ...
    cxx17::string_view getUserName() const { return _username; }

    /** Gets the password with the specified URI. */
    cxx17::string_view getPassword() const { return _password; }
    /**
     * Get host part of URI. If host is an IPv6 address, square brackets will be
     * returned, for example: "[::1]".
     */
    cxx17::string_view getHost() const { return _host; }
    /**
     ...
     */
    cxx17::string_view getHostName() const { return _hostName; }

    /** Gets the port number of the URI. */
    uint16_t getPort() const { return _port; }

    /** Gets the path part of the URI. */
    cxx17::string_view getPath() const { return _path; }

    /// Gets the path, query and fragment parts of the URI.
    cxx17::string_view getPathEtc() const { return _pathEtc; }

    /** Gets the query part of the URI. */
    cxx17::string_view getQuery() const { return _query; }

    /** Gets the fragment part of the URI */
    cxx17::string_view getFragment() const { return _fragment; }
     ...
     */
    cxx17::string_view getAuthority() const { return _authority; }
...
private:
    bool doParse(cxx17::string_view str);
