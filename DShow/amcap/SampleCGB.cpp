...
//
//  ISampleCGB is trying to connect the video pin to the MPEG2 demux.
...
HRESULT 
ISampleCGB::AllocCapFile( LPCOLESTR lpwstr, DWORDLONG dwlSize )
{
...
HRESULT 
ISampleCGB::ControlStream( const GUID *pCategory,
                                          const GUID *pType,
                                          IBaseFilter *pFilter,
...
HRESULT 
ISampleCGB::CopyCaptureFile(  LPOLESTR lpwstrOld,
                                              LPOLESTR lpwstrNew,
                                              int fAllowEscAbort,
...
HRESULT ISampleCGB::FindInterface(const GUID *pCategory,
                                                  const GUID *pType,
                                                  IBaseFilter *pf,
                                                  REFIID riid,
                                                  void **ppint
...
HRESULT 
ISampleCGB::FindPin( IUnknown *pSource,
...
HRESULT ISampleCGB::GetFiltergraph( IGraphBuilder **ppfg )
{
    return graphBuilder2_->GetFiltergraph( ppfg );
}

HRESULT 
ISampleCGB::RenderStream( const GUID *pCategory,
                                          const GUID *pType,
                                          IUnknown *pSource,
...
HRESULT 
ISampleCGB::SetFiltergraph( IGraphBuilder *pfg )
{
...
HRESULT 
ISampleCGB::SetOutputFileName(  const GUID *pType,
...
//
BOOL ISampleCGB::IsMPEG2Pin( IPin *pPin )
{
    if( !pPin )
    {
...
BOOL ISampleCGB::IsVideoPin( IPin *pPin )
{
...
HRESULT ISampleCGB::GetEncodersByCategory( IEnumMoniker **ppEncoders )
{
...
HRESULT 
ISampleCGB::GetEncodersByEnumerating(
                                        IPin *pPin,   
...
HRESULT ISampleCGB::AddMPEG2Demux( )
{
    if( pMPEG2Demux_ )
    {
        //
...
BOOL ISampleCGB::IsAudioPin( IPin *pPin )
{
    if( !pPin )
    {
        return FALSE;   // NULL pointer
...
BOOL ISampleCGB::HasMediaType(IPin *pPin,  REFGUID majorType )
{
    if( !pPin )
    {
        return FALSE;
...
HRESULT ISampleCGB::FindEncoder( 
...
HRESULT 
ISampleCGB::RenderToMPEG2Demux( IPin *pPin )
{
    if( !pPin )
    {
        return E_INVALIDARG;
...
//
HRESULT 
ISampleCGB::ConnectEncoderToMPEG2Demux( 
...
HRESULT 
ISampleCGB::GetMultiplexersByCategory( IEnumMoniker **ppMultiplexers )
{
    SmartPtr<ICreateDevEnum> pDeviceEnum;
...
HRESULT 
ISampleCGB::GetMultiplexersByFilterMapper( 
...
HRESULT 
ISampleCGB::ConnectMultiplexerToMPEG2Demux( 
                                        IBaseFilter *pEncoder, 
...
HRESULT 
ISampleCGB::BuildMPEG2Segment(IBaseFilter *pFilter)
{
...
HRESULT 
ISampleCGB::ConnectAudioPinToMultiplexer( 
                                            IPin *pPin, 
...
HRESULT ISampleCGB::ConfigureMPEG2Demux( IBaseFilter *pFilter)
{
...
HRESULT 
ISampleCGB::ConnectFilters(IBaseFilter *pUpFilter, IBaseFilter *pDownFilter)
{
