...
Reshape_x86_avx512::Reshape_x86_avx512()
{
#if __SSE2__
...
int Reshape_x86_avx512::forward(const std::vector<Mat>& bottom_blobs, std::vector<Mat>& top_blobs, const Option& opt) const
{
