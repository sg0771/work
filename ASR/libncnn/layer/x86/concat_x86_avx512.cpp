...
#include "concat_x86_avx512.h"

namespace ncnn {

Concat_x86_avx512::Concat_x86_avx512()
{
#if __SSE2__
...
int Concat_x86_avx512::forward(const std::vector<Mat>& bottom_blobs, std::vector<Mat>& top_blobs, const Option& opt) const
{
