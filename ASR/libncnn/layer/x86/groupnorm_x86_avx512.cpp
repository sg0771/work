...
#include "groupnorm_x86_avx512.h"
...
GroupNorm_x86_avx512::GroupNorm_x86_avx512()
{
#if __SSE2__
...
int GroupNorm_x86_avx512::forward_inplace(Mat& bottom_top_blob, const Option& opt) const
{
