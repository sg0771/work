...
#include "requantize_x86_avx512.h"
...
Requantize_x86_avx512::Requantize_x86_avx512()
{
#if __SSE2__
...
int Requantize_x86_avx512::forward(const Mat& bottom_blob, Mat& top_blob, const Option& opt) const
{
