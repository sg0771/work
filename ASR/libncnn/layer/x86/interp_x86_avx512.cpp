...
Interp_x86_avx512::Interp_x86_avx512()
{
#if __SSE2__
...
int Interp_x86_avx512::forward(const std::vector<Mat>& bottom_blobs, std::vector<Mat>& top_blobs, const Option& opt) const
{
