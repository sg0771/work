...
#include "shufflechannel_x86_avx512.h"
...
ShuffleChannel_x86_avx512::ShuffleChannel_x86_avx512()
{
#if __SSE2__
...
int ShuffleChannel_x86_avx512::forward(const Mat& bottom_blob, Mat& top_blob, const Option& opt) const
{
