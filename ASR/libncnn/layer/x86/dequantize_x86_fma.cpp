...
Dequantize_x86_fma::Dequantize_x86_fma()
{
#if __SSE2__
...
int Dequantize_x86_fma::forward(const Mat& bottom_blob, Mat& top_blob, const Option& opt) const
{
