...
#include "packing_x86_avx512.h"

#include "x86_usability.h"

namespace ncnn {

Packing_x86_avx512::Packing_x86_avx512()
{
    support_packing = true;
}

int Packing_x86_avx512::forward(const Mat& bottom_blob, Mat& top_blob, const Option& opt) const
{
