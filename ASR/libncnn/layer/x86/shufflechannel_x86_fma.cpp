...
#include "shufflechannel_x86_fma.h"
...
ShuffleChannel_x86_fma::ShuffleChannel_x86_fma()
{
#if __SSE2__
...
int ShuffleChannel_x86_fma::forward(const Mat& bottom_blob, Mat& top_blob, const Option& opt) const
{
