...
Pooling_x86_avx512::Pooling_x86_avx512()
{
#if __SSE2__
...
int Pooling_x86_avx512::forward(const Mat& bottom_blob, Mat& top_blob, const Option& opt) const
{
