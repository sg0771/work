...
Reshape_x86_fma::Reshape_x86_fma()
{
#if __SSE2__
...
int Reshape_x86_fma::forward(const std::vector<Mat>& bottom_blobs, std::vector<Mat>& top_blobs, const Option& opt) const
{
