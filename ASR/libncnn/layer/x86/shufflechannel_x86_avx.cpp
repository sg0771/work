...
#include "shufflechannel_x86_avx.h"
...
ShuffleChannel_x86_avx::ShuffleChannel_x86_avx()
{
#if __SSE2__
...
int ShuffleChannel_x86_avx::forward(const Mat& bottom_blob, Mat& top_blob, const Option& opt) const
{
