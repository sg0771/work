...
#include "deconvolution_x86_fma.h"
...
Deconvolution_x86_fma::Deconvolution_x86_fma()
{
#if __SSE2__
...
int Deconvolution_x86_fma::forward(const std::vector<Mat>& bottom_blobs, std::vector<Mat>& top_blobs, const Option& opt) const
{
