...
TFL_CAPI_EXPORT TfLiteStatus TfLiteInterpreterResetVariableTensors(
...
TFL_CAPI_EXPORT TfLiteInterpreter* TfLiteInterpreterCreateWithSelectedOps(
...
TFL_CAPI_EXPORT void TfLiteInterpreterOptionsSetOpResolver(
    TfLiteInterpreterOptions* options,
...
//TFL_CAPI_EXPORT void TfLiteInterpreterOptionsSetUseNNAPI(
//    TfLiteInterpreterOptions* options,
//                                         bool enable) {
//  options->use_nnapi = enable;
//}

TFL_CAPI_EXPORT void TfLiteInterpreterOptionsSetEnableDelegateFallback(
