...
TFL_CAPI_EXPORT const char* TfLiteVersion() { return TFLITE_VERSION_STRING; }

TFL_CAPI_EXPORT TfLiteModel* TfLiteModelCreate(const void* model_data,
                                               size_t model_size) {
...
TFL_CAPI_EXPORT void TfLiteModelDelete(TfLiteModel* model) { delete model; }
...
TFL_CAPI_EXPORT int32_t TfLiteTensorDim(const TfLiteTensor* tensor,
                                        int32_t dim_index) {
