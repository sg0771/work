...
void xnn_f32_vsqrt_ukernel__fma3_nr1fma1adj_x64(
    size_t n,
    const float* x,
    float* y,
    const union xnn_f32_sqrt_params params[XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; n >= 64 * sizeof(float); n -= 64 * sizeof(float)) {
    ...
    const __m256 vrsqrtx5 = _mm256_rsqrt_ps(vx5);
    const __m256 vrsqrtx6 = _mm256_rsqrt_ps(vx6);
    const __m256 vrsqrtx7 = _mm256_rsqrt_ps(vx7);
    ...
    __m256 vsqrtx5 = _mm256_mul_ps(vrsqrtx5, vx5);
    __m256 vhalfrsqrtx5 = _mm256_mul_ps(vrsqrtx5, vhalf);
    __m256 vsqrtx6 = _mm256_mul_ps(vrsqrtx6, vx6);
    __m256 vhalfrsqrtx6 = _mm256_mul_ps(vrsqrtx6, vhalf);
    __m256 vsqrtx7 = _mm256_mul_ps(vrsqrtx7, vx7);
    __m256 vhalfrsqrtx7 = _mm256_mul_ps(vrsqrtx7, vhalf);
    ...
    const __m256 vresidual5 = _mm256_fnmadd_ps(vsqrtx5, vhalfrsqrtx5, vhalf);
    const __m256 vresidual6 = _mm256_fnmadd_ps(vsqrtx6, vhalfrsqrtx6, vhalf);
    const __m256 vresidual7 = _mm256_fnmadd_ps(vsqrtx7, vhalfrsqrtx7, vhalf);
    ...
    vhalfrsqrtx5 = _mm256_fmadd_ps(vhalfrsqrtx5, vresidual5, vhalfrsqrtx5);
    vsqrtx5 = _mm256_fmadd_ps(vsqrtx5, vresidual5, vsqrtx5);
    vhalfrsqrtx6 = _mm256_fmadd_ps(vhalfrsqrtx6, vresidual6, vhalfrsqrtx6);
    vsqrtx6 = _mm256_fmadd_ps(vsqrtx6, vresidual6, vsqrtx6);
    vhalfrsqrtx7 = _mm256_fmadd_ps(vhalfrsqrtx7, vresidual7, vhalfrsqrtx7);
    vsqrtx7 = _mm256_fmadd_ps(vsqrtx7, vresidual7, vsqrtx7);
    ...
    const __m256 vadjustment5 = _mm256_fnmadd_ps(vsqrtx5, vsqrtx5, vx5);
    const __m256 vadjustment6 = _mm256_fnmadd_ps(vsqrtx6, vsqrtx6, vx6);
    const __m256 vadjustment7 = _mm256_fnmadd_ps(vsqrtx7, vsqrtx7, vx7);
    ...
    const __m256 vy5 = _mm256_fmadd_ps(vhalfrsqrtx5, vadjustment5, vsqrtx5);
    const __m256 vy6 = _mm256_fmadd_ps(vhalfrsqrtx6, vadjustment6, vsqrtx6);
    const __m256 vy7 = _mm256_fmadd_ps(vhalfrsqrtx7, vadjustment7, vsqrtx7);
