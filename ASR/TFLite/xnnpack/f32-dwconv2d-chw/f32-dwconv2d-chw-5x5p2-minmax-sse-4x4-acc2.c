...
void xnn_f32_dwconv2d_chw_ukernel_5x5p2__sse_4x4_acc2(
    size_t input_height,
    size_t input_width,
    const float* input,
    const float* weights,
    ...
    const union xnn_f32_chw_params params[XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    for (; w > 8 * sizeof(float); w -= 4 * sizeof(float)) {
      ...
      __m128 vo3p1 = _mm_mul_ps(vi4x4567, vk12);
      ...
      vo3p1 = _mm_add_ps(vo3p1, _mm_mul_ps(vi6x4567, vk32));
      ...
      vo3p1 = _mm_add_ps(vo3p1, _mm_mul_ps(vi3x3456, vk01));
      ...
      vo3p1 = _mm_add_ps(vo3p1, _mm_mul_ps(vi5x3456, vk21));
      ...
      vo3p1 = _mm_add_ps(vo3p1, _mm_mul_ps(vi7x3456, vk41));
      ...
      vo3p1 = _mm_add_ps(vo3p1, _mm_mul_ps(vi4x2345, vk10));
      ...
      vo3p1 = _mm_add_ps(vo3p1, _mm_mul_ps(vi6x2345, vk30));
      ...
      vo3p1 = _mm_add_ps(vo3p1, _mm_mul_ps(vi3x5678, vk03));
      ...
      vo3p1 = _mm_add_ps(vo3p1, _mm_mul_ps(vi5x5678, vk23));
      ...
      vo3p1 = _mm_add_ps(vo3p1, _mm_mul_ps(vi7x5678, vk43));
      ...
      vo3p1 = _mm_add_ps(vo3p1, _mm_mul_ps(vi4x6789, vk14));
      ...
      vo3p1 = _mm_add_ps(vo3p1, _mm_mul_ps(vi6x6789, vk34));
