...
void xnn_f32_dwconv2d_chw_ukernel_5x5s2p2__sse_3x4_acc2(
    size_t input_height,
    size_t input_width,
    const float* input,
    const float* weights,
    ...
    const union xnn_f32_chw_params params[XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    for (; w > 8 * sizeof(float); w -= 8 * sizeof(float)) {
      ...
      __m128 vo2p1 = _mm_mul_ps(vi5x8ACE, vk12);
      ...
      vo2p1 = _mm_add_ps(vo2p1, _mm_mul_ps(vi7x8ACE, vk32));
      ...
      vo2p1 = _mm_add_ps(vo2p1, _mm_mul_ps(vi4x9BDF, vk03));
      ...
      vo2p1 = _mm_add_ps(vo2p1, _mm_mul_ps(vi6x9BDF, vk23));
      ...
      vo2p1 = _mm_add_ps(vo2p1, _mm_mul_ps(vi8x9BDF, vk43));
      ...
      vo2p1 = _mm_add_ps(vo2p1, _mm_mul_ps(vi5x68AC, vk10));
      ...
      vo2p1 = _mm_add_ps(vo2p1, _mm_mul_ps(vi7x68AC, vk30));
      ...
      vo2p1 = _mm_add_ps(vo2p1, _mm_mul_ps(vi4x79BD, vk01));
      ...
      vo2p1 = _mm_add_ps(vo2p1, _mm_mul_ps(vi6x79BD, vk21));
      ...
      vo2p1 = _mm_add_ps(vo2p1, _mm_mul_ps(vi8x79BD, vk41));
      ...
      vo2p1 = _mm_add_ps(vo2p1, _mm_mul_ps(vi5xACEG, vk14));
      ...
      vo2p1 = _mm_add_ps(vo2p1, _mm_mul_ps(vi7xACEG, vk34));
