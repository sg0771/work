...
void xnn_f32_dwconv_minmax_ukernel_up16x25__avx_acc2(
    size_t channels,
    size_t output_width,
    const float** input,
    const float* weights,
    ...
    const union xnn_f32_minmax_params params[XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    for (; c >= 16; c -= 16) {
      ...
      vacc89ABCDEFp1 = _mm256_add_ps(vacc89ABCDEFp1, _mm256_mul_ps(vi9x89ABCDEF, vk9x89ABCDEF));
      ...
      vacc89ABCDEFp1 = _mm256_add_ps(vacc89ABCDEFp1, _mm256_mul_ps(vi11x89ABCDEF, vk11x89ABCDEF));
      ...
      vacc89ABCDEFp1 = _mm256_add_ps(vacc89ABCDEFp1, _mm256_mul_ps(vi13x89ABCDEF, vk13x89ABCDEF));
      ...
      vacc89ABCDEFp1 = _mm256_add_ps(vacc89ABCDEFp1, _mm256_mul_ps(vi15x89ABCDEF, vk15x89ABCDEF));
      ...
      vacc89ABCDEFp1 = _mm256_add_ps(vacc89ABCDEFp1, _mm256_mul_ps(vi17x89ABCDEF, vk17x89ABCDEF));
      ...
      vacc89ABCDEFp1 = _mm256_add_ps(vacc89ABCDEFp1, _mm256_mul_ps(vi19x89ABCDEF, vk19x89ABCDEF));
      ...
      vacc89ABCDEFp1 = _mm256_add_ps(vacc89ABCDEFp1, _mm256_mul_ps(vi21x89ABCDEF, vk21x89ABCDEF));
      ...
      vacc89ABCDEFp1 = _mm256_add_ps(vacc89ABCDEFp1, _mm256_mul_ps(vi23x89ABCDEF, vk23x89ABCDEF));
