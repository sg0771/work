...
GGML_API void sense_voice_log_internal(ggml_log_level level, const char *format, ...);
GGML_API void sense_voice_log_callback_default(ggml_log_level level, const char *text, void *user_data);
