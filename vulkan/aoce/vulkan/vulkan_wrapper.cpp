...
int InitVulkanOnce(void) {
...
#ifdef _WIN32
        libvulkan = LoadLibraryA(s.c_str());  //"vulkan-1.dll"
#else
    ...
    if (nullptr == libvulkan) {
#ifdef _WIN32
        OutputDebugStringA("Load vulkan library error\n");
#else
    ...
    vkGetImageMemoryRequirements2 =
        reinterpret_cast<PFN_vkGetImageMemoryRequirements2>(
            MNN_DLSYM(libvulkan, "vkGetImageMemoryRequirements2"));


    vkGetPhysicalDeviceImageFormatProperties2 =
        reinterpret_cast<PFN_vkGetPhysicalDeviceImageFormatProperties2>(
            MNN_DLSYM(libvulkan, "vkGetPhysicalDeviceImageFormatProperties2"));
